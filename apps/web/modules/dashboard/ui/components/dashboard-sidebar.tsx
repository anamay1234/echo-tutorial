                ...
                appearance={{
                  elements: {
                    ...
                    organizationSwitcherTrigger:
                      "w-full! justify-start! group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-0! group-data-[collapsible=icon]:justify-center!",
                    organizationPreview:
                      "gap-2! group-data-[collapsible=icon]:justify-center! group-data-[collapsible=icon]:w-full!",
